...
"")
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 63, 351, 161))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        ...
        self.applyFilters.setGeometry(QtCore.QRect(12, 250, 351, 41))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
...
"border-radius:10%")
        ...
        self.inputSearch.setGeometry(QtCore.QRect(170, 10, 191, 41))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(11)
